...
def generate_recommendations(selected_results, idx_and_othersymptoms):
    ...
    Args:
        selected_results: _description_
        idx_and_othersymptoms: _description_
...
def get_symptom_descriptions(symptoms):
    ...
    Arguments:
    symptoms -- array of the symptoms
    Return: symptom_descriptions -- dictionary of the symptoms and their descriptions
    """
...
def cal_coverage(clicked_symptoms, idx_and_othersymptoms):
    """
    Args:
        clicked_symptoms (_type_): _description_
        idx_and_othersymptoms (_type_): _description_
